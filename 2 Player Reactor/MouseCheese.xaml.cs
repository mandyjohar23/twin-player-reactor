...
namespace _2_Player_Reactor
{
    ...
    public partial class Page7 : PhoneApplicationPage
    {
        ...
        public Page7()
        {
            ...
            dispatcherTimer.Interval = new TimeSpan(0, 0, 0, 4, 0);
        ...
        private void dispatcherTimer_tick(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    image1.Source = new BitmapImage(new Uri("/mouseCheese/true1.png", UriKind.Relative));
                    answer = true;
                    break;
                case 1:
                    image1.Source = new BitmapImage(new Uri("/mouseCheese/false1.png", UriKind.Relative));
                    answer = false;
                    break;
                case 2:
                    image1.Source = new BitmapImage(new Uri("/mouseCheese/false2.png", UriKind.Relative));
                    answer = false;
                    break;
                case 3:
                    image1.Source = new BitmapImage(new Uri("/mouseCheese/false3.png", UriKind.Relative));
                    answer = false;
                    break;
                case 4:
                    image1.Source = new BitmapImage(new Uri("/mouseCheese/true2.png", UriKind.Relative));
                    answer = true;
                    break;
                case 5:
                    image1.Source = new BitmapImage(new Uri("/mouseCheese/true3.png", UriKind.Relative));
                    answer = true;
                    break;
                case 6:
                    image1.Source = new BitmapImage(new Uri("/mouseCheese/true4.png", UriKind.Relative));
                    answer = true;
                    break;
                case 7:
                    image1.Source = new BitmapImage(new Uri("/mouseCheese/false4.png", UriKind.Relative));
                    answer = false;
                    break;
                case 8:
                    image1.Source = new BitmapImage(new Uri("/mouseCheese/true5.png", UriKind.Relative));
                    answer = true;
                    break;
                case 9:
                    image1.Source = new BitmapImage(new Uri("/mouseCheese/false5.png", UriKind.Relative));
                    answer = false;
                    break;
            }
        }
