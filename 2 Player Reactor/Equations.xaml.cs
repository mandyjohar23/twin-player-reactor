...
namespace _2_Player_Reactor
{
    public partial class Page2 : PhoneApplicationPage
    {
        ...
        Boolean answer;
        int temp;
        int n1, n2, navigateCheck = 0, navigateCheck2 = 0;
        public Page2()
        {
            InitializeComponent();
