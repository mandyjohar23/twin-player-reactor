    ...
    public partial class Page1 : PhoneApplicationPage
    {
        ...
        private void dispatcherTimer_tick(object sender, EventArgs e)
        {
            ...
            switch (temp)
            {
                ...
                case 4:
                    textblock1.Text = textblock2.Text = "Red";
                    textblock1.Foreground = new SolidColorBrush(Colors.Purple);
                    textblock2.Foreground = new SolidColorBrush(Colors.Purple);
                    answer = false;
                    break;
                case 5:
                    textblock1.Text = textblock2.Text = "Yellow";
                ...
                case 6:
                    ...
                    break;
                case 7:
                    textblock1.Text = textblock2.Text = "Brown";
                    textblock1.Foreground = new SolidColorBrush(Colors.Orange);
                    textblock2.Foreground = new SolidColorBrush(Colors.Orange);
                    answer = false;
                    break;
                case 8:
                    textblock1.Text = textblock2.Text = "Purple";
                    textblock1.Foreground = new SolidColorBrush(Colors.Magenta);
                    textblock2.Foreground = new SolidColorBrush(Colors.Magenta);
                    answer = false;
                    break;
                case 9:
                    textblock1.Text = textblock2.Text = "Green";
                    textblock1.Foreground = new SolidColorBrush(Colors.Cyan);
                    textblock2.Foreground = new SolidColorBrush(Colors.Cyan);
                    answer = false;
                    break;
